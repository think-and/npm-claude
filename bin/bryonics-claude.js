...
switch (command) {
  ...
  case "pin":
    ...
    break;
  default:
    console.log("Bryonics — Team Knowledge Layer for Claude Code");
    console.log("");
    console.log("Usage: npx @bryonics/claude@latest <command>");
    console.log("");
    console.log("Commands:");
    console.log("  install      Install Bryonics hooks and commands");
    console.log("  update       Update to the latest version");
    console.log("  doctor       Check installation health");
    console.log("  uninstall    Remove Bryonics from Claude Code");
